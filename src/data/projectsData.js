...
export const projectsData = [
  {
    ...
    slug: "readable",
    image: testImg1,
    badgeNames: ["react", "redux", "firebase", "tailwind"],
    description: [
  ...
  },
  {
    ...
    image: testImg2,
    badgeNames: ["react", "redux", "express"],
    description: [
  ...
  },
  {
    ...
    slug: "contentful-blog",
    image: testImg3,
    badgeNames: ["react", "gatsby", "graphQl"],
    description: [
  ...
  },
  {
    ...
    slug: "flashcards",
    image: flashcardsImg,
    badgeNames: ["reactNative", "expo", "styledComponents"],
    description: [
